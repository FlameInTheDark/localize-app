...
import { ArrowLeft, FileText, Image as ImageIcon, ScanText, Settings, Type } from "lucide-react";
...
const tabs: Array<{ id: WorkspaceTab; label: string; Icon: typeof Type }> = [
  ...
  { id: "image", label: "Image", Icon: ImageIcon }, { id: "ocr", label: "OCR", Icon: ScanText },
];
